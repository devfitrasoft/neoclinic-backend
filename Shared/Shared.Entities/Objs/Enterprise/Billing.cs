...
namespace Shared.Entities.Objs.Enterprise
{
    ...
    public class Billing
    {
        ...
        [Column("amount_due")] public decimal? AmountDue { get; set; }   //  for monthly : sys_billing_setting.transaction_price_per_unit x transaction_count, register : see sys_billing_setting.registration_fee
